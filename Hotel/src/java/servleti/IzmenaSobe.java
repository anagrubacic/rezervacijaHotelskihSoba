 ...
 * @author user
 */
public class IzmenaSobe extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!opis.equals("") && !image.equals("")) {
                try {
                    ...
                    String stmt = "UPDATE room SET roomType=?,hotel=?,numberOfBeds=?,description=?,image=?,number=?,price=?,points=? WHERE room_id=?";
                    ...
                    String putanja = "AdminSobe?hotel_id=" + hotel_id;
                    response.sendRedirect(putanja);
                } catch (Exception ex) {
                    request.setAttribute("msg", "Sva polja su obavezna!");
                    String path = "IzmeniSobuManager.jsp?room_id=" + id + "&hotel_id=" + hotel_id;
